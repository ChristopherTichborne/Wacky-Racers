...
configuration information. The \file{wacky-racers/src/boards}
...
\file{wacky-racers/src/demo-apps/led\_test1/led\_test1.c}. The macros
\code{LED1\_PIO} and \code{LED2\_PIO} need to be defined in
\file{target.h} (see
\protect\hyperref[configuration]{configuration}). If your LEDs are
active high, replace \code{ActiveLow} with \code{ActiveHigh}.
...
\file{wacky-racers/src/demo-apps/usbserial\_hello1/usbserial\_hello1.c}.
...
\file{wacky-racers/demo-apps}. Where possible these are written to be
...
The program
\href{https://eng-git.canterbury.ac.nz/mph/wacky-racers-2021/blob/master/src/test-apps/pwm_test2/pwm_test2.c}{\file{src/test-apps/pwm\_test2/pwm\_test2.c}}
...
PWM signals. See
\href{https://eng-git.canterbury.ac.nz/mph/wacky-racers-2021/blob/master/src/mat91lib/pwm/pwm.c}{\file{src/mat91lib/pwm/pwm.c}}
...
The program
\href{https://eng-git.canterbury.ac.nz/mph/wacky-racers-2021/blob/master/src/demo-apps/imu_test1/imu_test1.c}{\file{wacky-racers/src/demo-apps/imu\_test1/imu\_test1.c}}
...
The program
\href{https://eng-git.canterbury.ac.nz/mph/wacky-racers-2021/blob/master/src/demo-apps/radio_tx_test1/radio_tx_test1.c}{\file{wacky-racers/src/demo-apps/radio\_tx\_test1/radio\_tx\_test1.c}}
provides an example of using the radio as a transmitter.

The companion program
\href{https://eng-git.canterbury.ac.nz/mph/wacky-racers-2021/blob/master/src/demo-apps/radio_rx_test1/radio_rx_test1.c}{\file{wacky-racers/src/demo-apps/radio\_rx\_test1/radio\_rx\_test1.c}}
...
\file{wacky-racers/src/wacky-apps/hat/hat.c} and
\file{wacky-racers/src/wacky-apps/racer/racer.c}. We recommend that
...
The building is controlled by \file{mat91lib/mat91lib.mk}. This is a
makefile fragment loaded by \file{mmculib/mmculib.mk}.
\file{mat91lib/mat91lib.mk} loads other makefile fragments for each
