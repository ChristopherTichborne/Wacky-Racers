...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{$ }\ExtensionTok{telnet}\NormalTok{ localhost:4444}
\OperatorTok{>} \ExtensionTok{monitor}\NormalTok{ flash info 0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{$ }\FunctionTok{gdb}
\KeywordTok{(}\FunctionTok{gdb}\KeywordTok{)} \ExtensionTok{target}\NormalTok{ remote localhost:3333}
\KeywordTok{(}\FunctionTok{gdb}\KeywordTok{)} \ExtensionTok{monitor}\NormalTok{ flash info 0}
\end{Highlighting}
\end{Shaded}
